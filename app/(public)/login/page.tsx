  ...
  return (
    <main>
      <div className="flex h-screen py-20 lg:py-0 lg:flex-row flex-col lg:px-0 px-4 lg:justify-between lg:gap-0 gap-14 justify-center  w-full lg:overflow-hidden">
        {/* Left */}
        <div className="lg:w-1/2 lg:order-1 order-2 flex justify-end xl:pr-[200px] lg:pr-[100px] lg:pl-[100px] items-center ">
          <LoginForm />
        </div>
        {/* Right */}
        <div className="lg:w-1/2 w-full lg:order-2 flex flex-col  relative">
